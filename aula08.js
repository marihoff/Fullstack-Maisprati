...
// Sem Number(), a conta matemática não funcionaria corretamente. let celsius = Number(PROMPT('Informe a temperatura que deseja converter em Fahrenheit: '))

// Fórmula oficial de conversão: F = (C × 9/5) + 32
// Multiplicamos por 9/5 (equivale a 1.8) e somamos 32 ao final. let fahrenheit = (celsius * 9/5) + 32

// Exibe o resultado para o usuário no terminal. console.log('O resultado em fahrenheit é: ' + fahrenheit)
...
if(celsius < -273.15) {
    console.log('Temperatura inválida. A temperatura mínima possível é -273.15°C.')
}
...
// Criamos um array vazio para guardar os números que satisfazem a condição. let encontrados = []
...
// - numero++           → a cada volta, soma 1 ao número atualfor (let numero = 1000; numero <= 1999; numero++) {
...
//Escreva um programa para calcular a redução do tempo de vida de um fumante. Pergunte a quantidade de cigarros fumados por dia e quantos anos ele já fumou. Considere que um fumante perde 10 min de vida a cada cigarro. Calcule quantos dias de vida um fumante perderá e exiba o total em dias.
